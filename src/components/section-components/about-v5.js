...
class AboutV5 extends Component {
  ...
  async componentDidMount() {
    try {
      ...
      querySnapshot.forEach((doc) => {
        ...
        this.setState({
          ...
          no_of_customer : data.no_of_customer || "default number"
        });
      });
    } catch (error) {
    ...
    render() {
		...
		const { officename, no_of_customer} = this.state;
    ...
    return <div className="ltn__about-us-area pb-115 go-top">
				...
				<div className="row">
					...
					<div className="about-us-info-wrap">
						...
						<h1 className="section-title"> {officename}<span>.</span></h1>
						<p>more than {no_of_customer} clients deal with us in Egypt</p>
						</div>
